...
package railk.as3.motion
{
	...
	public class RTween
	{
		...
		static public function soundTransformTo( target:*, duration:Number, volume:Number, pan:Number, ease:Function=null):IRTween { return StandartTween.to(target, duration, {volume:volume, pan:pan}, {ease:ease}); }
