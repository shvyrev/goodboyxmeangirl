...
class Zend_Amf_Request
{
	...
	/**
     * Return an Object with the credentials identity and password
     *
     * @return object {userid:, password:}
     */
	public function getCredentials() {
		$h = $this->_headers;
		for ($j = 0; $j < count(h); $j++) if ($h[$j]->name == Zend_Amf_Constants::CREDENTIALS_HEADER ) return $h[$j]->data;
		return null;
	}
