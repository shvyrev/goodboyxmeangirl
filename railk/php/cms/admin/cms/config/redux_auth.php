...
$config['auth']['salt']	= 'D75D021A85A66817ACB9CE7301AFE67AF5A242A07799C18A9C8C7FDF5D819670';
...
$config['auth']['mail']['smtp_host'] 	= 'smtp@wanadoo.fr'; 
$config['auth']['mail']['smtp_user'] 	= '';
$config['auth']['mail']['smtp_pass'] 	= ''; 
$config['auth']['mail']['smtp_port'] 	= '25';
$config['auth']['mail_from_email'] 		= 'admin@website.fr';
$config['auth']['mail_from_name'] 		= 'admin';
...
|
*/
$config['auth']['forgotten_password_subject'] = 'Website.frForgotten Password Request';
