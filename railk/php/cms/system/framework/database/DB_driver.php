...
class CI_DB_driver {
	...
	function load_rdriver()
	{
		...
		{
			include_once(FWPATH.'database/DB_result'.EXT);
			include_once(FWPATH.'database/drivers/'.$this->dbdriver.'/'.$this->dbdriver.'_result'.EXT);
		}
	...
	function _cache_init()
	{
		...
		if ( ! @include(FWPATH.'database/DB_cache'.EXT))
		{
