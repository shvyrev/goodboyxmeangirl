...
package railk.as3.display.graphicShape
{
	...
	{
		public function RoundRectangleShape(color:uint=0x000000,X:Number=0,Y:Number=0,W:Number=100,H:Number=100,cornerW:Number=30,cornerH:Number=NaN,lineThickness:Number=NaN,lineColor:uint=0xFFFFFF,copy:Boolean=false ) {
			super(copy);
