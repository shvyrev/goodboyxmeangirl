...
package railk.as3.display.graphicShape
{
	...
	{
		public function RectangleShape(color:uint=0x000000,X:Number=0,Y:Number=0,W:Number=1,H:Number=1,lineThickness:Number=NaN,lineColor:uint=0xFFFFFF,copy:Boolean=false ) {
			super(copy);
			_type = 'rectangle';
