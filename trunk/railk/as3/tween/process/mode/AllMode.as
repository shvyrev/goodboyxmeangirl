package railk.as3.tween.process.mode {
	...
	import railk.as3.tween.process.plugin.color.ColorPlugin;
	...
	public class AllMode implements IMode {
		...
		public function AllMode():void { 
			...
			plugins = [new ColorPlugin(), new TintPlugin(), new TextPlugin(), new SoundPlugin(), new BevelFilterPlugin(), new BlurFilterPlugin(), new DropShadowFilterPlugin(), new GlowFilterPlugin(), /*new BezierPlugin()*/ ]
		}
