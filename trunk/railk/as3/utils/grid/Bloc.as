...
package railk.as3.utils.grid {
	...
	public class Bloc extends Object {
		...
		public function set isUsed(b:Boolean):void{ 
			used = b;
		}
		...
		public function set beginX(x:int):void {
			_beginX = x;
		}
		...
		public function set beginY(y:int):void {
			_beginY = y;
		}
		...
		public function set endX(x:int):void {
			_endX = x;
		}
		...
		public function set endY(y:int):void {
			_endY = y;
		}
		...
		public function toString():String {
			return "[Bloc > id is " + id + " beginning  at x:"+ beginX +",y:"+beginY+" and w:"+width+",h:"+height+"]";
		}
	}
}