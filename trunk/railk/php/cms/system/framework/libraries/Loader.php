...
class CI_Loader {
	...
	function database($params = '', $return = FALSE, $active_record = FALSE)
	{
		...
		require_once(FWPATH.'database/DB'.EXT);
	...
	function dbutil()
	{
		...
		require_once(FWPATH.'database/DB_utility'.EXT);
		require_once(FWPATH.'database/drivers/'.$CI->db->dbdriver.'/'.$CI->db->dbdriver.'_utility'.EXT);
	...
	function dbforge()
	{
		...
		require_once(FWPATH.'database/DB_forge'.EXT);
		require_once(FWPATH.'database/drivers/'.$CI->db->dbdriver.'/'.$CI->db->dbdriver.'_forge'.EXT);
	...
	function helper($helpers = array())
	{
		...
		{		
			...
			{
				$base_helper = FWPATH.'helpers/'.$helper.EXT;
			...
			{		
				if (file_exists(FWPATH.'helpers/'.$helper.EXT))
				{
					include_once(FWPATH.'helpers/'.$helper.EXT);
				}
				else
				{
					show_error('Unable to load the requested file: helpers/'.$helper.EXT);
	...
	function plugin($plugins = array())
	{
		...
		{	
			...
			{
				if (file_exists(FWPATH.'plugins/'.$plugin.EXT))
				{
					include_once(FWPATH.'plugins/'.$plugin.EXT);	
				}
				else
				{
	...
	{	
		...
		foreach (array(ucfirst($class), strtolower($class)) as $class)
		{
			...
			{
				$baseclass = FWPATH.'libraries/'.ucfirst($class).EXT;
