...
/**
 * Flow cms/frontend framework based on codeIgniter
 *
 ...
 * ------------------------------------------------------
 */
require( FWPATH.'flow/Common'.EXT);
 ...
 * ------------------------------------------------------
 */
require( FWPATH.'flow/Compat'.EXT);
...
if (floor(phpversion()) < 5)
{
	...
	require(FWPATH.'flow/Base4'.EXT);
}
else
{
	require(FWPATH.'flow/Base5'.EXT);
}
